...
async function createWorldContract(wallet) {
...
async function createMetadataSystemContract(wallet, metadataSystemAddress) {
...
async function encodeNamespace(namespaceBytes) {
